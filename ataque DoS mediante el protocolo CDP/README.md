...
![Script parte 1](captura_script_parte1.png)

**Parte 2 — Bucle de ataque, manejo de argumentos y punto de entrada:**

![Script parte 2](captura_script_parte2.png)

**Ejecución del script:**

![Ejecución del script](captura_script_ejecucion.png)
...
![Configuración R1](captura_r1_config.png)
...
![Wireshark antes del ataque](captura_wireshark_antes.png)
...
![Wireshark durante el ataque](captura_wireshark_durante.png)
...
![Víctima sin IP](captura_victima_sin_ip1.png)

![Víctima sin IP](captura_victima_sin_ip2.png)
